...
public class Server  implements ActionListener {
    ...
    Server()
    {
        ...
        p1.setBackground(new Color(232,40,219));
        ...
        JLabel name = new JLabel("Divyanshu");
        name.setBounds(110,15,100,18);
        name.setForeground(Color.white);
        name.setFont(new Font("SANS_SERIF",Font.BOLD,14));
        p1.add(name);
        ...
        text = new JTextField();
        text.setBounds(5,650,325,40);
        text.setFont(new Font("SANS_SERIF",Font.PLAIN, 16));
        f.add(text);
        
        JButton send = new JButton("Send");
        send.setBounds(333,650,108,40);
        send.setBackground(new Color(232,40,219));
        ...
        f.addComponentListener(new ComponentAdapter() {
               @Override
                public void componentResized(ComponentEvent e) {
                  f.setShape(new RoundRectangle2D.Double(0, 0, e.getComponent().getWidth(), e.getComponent().getHeight(), 50, 60));
                }
            });
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(232,40,219));
